...
const Header = () => {
  ...
  return (
    <div className="headerBackgroundImage h-screen w-full bg-cover relative -mb-[16rem] lg:mb-0">
      <div className="w-11/12 mx-auto flex lg:gap-10 ">
        <div className="flex flex-col md:mt-5 md:w-full lg:w-[150rem] gap-4 text-white lg:ml-10 xl:ml-[5rem] lg:py-24">
          ...
          <p className="lg:text-lg text-[10px] -mt-2 lg:max-w-sm font-Roboto">
        ...
        <div className="w-[100rem] h-[10rem] md:h-[20rem] lg:w-[100rem] lg:h-[43.125rem] xl:w-[160rem] xl:h-[50rem] mt-16 lg:-mt-[1rem]">
