          ...
          <div className="flex flex-col md:flex-row justify-between gap-10 mt-10">
            <div className="hidden md:block flex-col gap-3">
              ...
              <div className="flex mt-4 gap-5 text-white text-3xl">
                ...
                <a className="duration-300 transition-all" href="">
                  <FaSquareXTwitter />
                </a>
            ...
            <div className="flex flex-col gap-2 font-Roboto">
              <h3 className="flex text-white font-semibold text-sm lg:text-xl">CONTACT</h3>
              <div className="flex gap-2 text-white text-sm lg:text-lg font-normal">
                <ImLocation className="text-xl" />
                <p>Sector 63, Noida, India</p>
              </div>
              <div className="flex gap-2 text-white text-sm lg:text-lg font-normal">
                <TfiEmail className="text-xl" />
                <p>hello@unarrown.com</p>
              </div>
              <div className="flex gap-2 text-white text-sm lg:text-lg font-normal">
