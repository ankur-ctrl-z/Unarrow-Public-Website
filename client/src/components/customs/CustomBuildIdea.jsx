...
const CustomBuildIdea = ({children, image, clasName, text, icon , ...props}) => {
  return (
    <div  className={`flex justify-center items-center group w-[75px] h-[65px] lg:text-[3.125rem] leading-normal md:w-[10.5rem] md:h-[8rem] lg:w-[14.5rem] lg:h-[13rem] xl:w-[20.5rem] xl:h-[15rem] flex-shrink-0 rounded-md ${clasName}`} {...props}>
